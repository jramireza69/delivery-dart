...
import 'package:untitled1/src/pages/client/orders/list/client_orders_list_controller.dart';
import 'package:untitled1/src/pages/delivery/orders/list/delivery_orders_list_controller.dart';
import 'package:untitled1/src/utils/relative_time_util.dart';
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      margin: EdgeInsets.only(top: 5),
                      alignment: Alignment.centerLeft,
                      child: Text('Repartidor: ${order.delivery?.name ?? 'Mensajero no asignado'} ${order.delivery?.lastname ?? ''}'),
                    ),
                    Container(
                      width: double.infinity,
                      margin: EdgeInsets.only(top: 5),
